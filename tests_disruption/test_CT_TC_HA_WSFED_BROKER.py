...
logger = logging.getLogger('keycloak-tool.tests_disruption.test_CT_TC_HA_WSFED_BROKER')
logger.setLevel(logging.DEBUG)


@pytest.mark.usefixtures('settings')
class Test_CT_TC_HA_WSFED_BROKER():
    """
    ...
    def test_CT_TC_HA_DB_WSFED_BROKER_ACCESS_CONTROL_RBAC_OK(self, settings):
        # After first round trip, kill all DB nodes, scenario still ok
        pass

    def test_CT_TC_HA_DB_WSFED_BROKER_ACCESS_CONTROL_RBAC_KO(self, settings):
        # After first round trip, kill all DB nodes, scenario still ok
        pass
